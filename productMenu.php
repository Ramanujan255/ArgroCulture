...
<html lang="en">
    ...
    <center>
        <div class="row">
            ...
            <div class="col-sm-5">
                <!-- Search text box replacing the dropdown -->
                <input type="text" name="search" id="search" 
                       placeholder="Search Product" 
                       style="width: 100%; padding: 10px; background-color: white; color: black; font-size: 16px;" 
                       required />
            </div>
            <div class="col-sm-2">
...
if (isset($_GET['search'])) {
    $searchTerm = dataFilter($_GET['search']);
    $sql = "SELECT * FROM fproduct WHERE product LIKE '%$searchTerm%'";
} else {
...
?>
					...
					<?php
						...
						?>
							...
							<blockquote><?php echo "Type : ".$row['pcat'].'';?><br><?php echo "Price : ".$row['price'].' Gh₵';?><br></blockquote>
